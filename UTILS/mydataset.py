...
#     dataset = VOCDetectionDataSet(voc_root="./dataset/VOCdevkit/VOC2012/", txt_name="train.txt")
#     dataloader = data.DataLoader(dataset, batch_size=1, shuffle=True, num_workers=0, collate_fn=dataset.collate_fn)
